                            ...
                            <div className="form-grid">
                                <div className="form-group">
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => /^[A-Za-z\s]*$/.test(e.target.value) && handleEmployeeInput(e)}
                                ...
                                <div className="form-group">
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => /^\d{0,10}$/.test(e.target.value) && handleEmployeeInput(e)}
